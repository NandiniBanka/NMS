 ...
 <div id="container">
    <div id="child1">
        ...
        <div id="child2">
            ...
            <?php require_once('emp_graphs.php');?>
                <div class="card">
                        <h2>Updates</h2><br>
                        <p>No new updates</p>
                    </div><br><br>
                ...
                <div class="stats">                   
                    ...
                    <?php $statement = "SELECT AVG(dr.traffic_volume) as net_traf FROM device_report dr JOIN devices d ON dr.id = d.id WHERE d.employee_id = '$user_id'";
